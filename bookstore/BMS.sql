...
--    tag_main    VARCHAR2(3)    REFERENCES tag_main(tag_main) ON DELETE CASCADE,
--    tag_sub     VARCHAR2(3) --ALTER TABLE TAG_SUB MODIFY TAG_SUB VARCHAR2(40);
--);
...
--CREATE SEQUENCE mem_his_sq --회원 데이터 수정 기록
--	START WITH 1
--    INCREMENT BY 1
--    MAXVALUE 9999;
--
...
--	id				VARCHAR2(15)	REFERENCES 	member(id)	ON DELETE CASCADE,
--	before_date		DATE,
--	after_date		DATE,
--	create_dt		DATE
--);
