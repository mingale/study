...
<h3>주문 상세 정보</h3>
	...
	<ul class="content1">
		...
		<c:forEach var="order" items="${orders}">
			<li>
				<ul class="item clearfix">
					<li class="image lineCen"><img src="${imageBook}${order.book.image}"></li>
					<li class="number lineCen">${order.book.title}</li>
					<li class="count lineCen">${order.order_count}</li>
					<li class="price lineCen">${order.order_price}</li>
				</ul>
			</li>
		</c:forEach>
	</ul>
