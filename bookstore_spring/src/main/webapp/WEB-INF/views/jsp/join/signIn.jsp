...
<section class="wrap">
	<div class="container">
		...
		<form action="signInPro" name="signInForm" method="post" class="content" onsubmit="return signInCheck();">
			<div class="login">
		    ...
		    <div class="join">
		        ...
		        <input class="inputButton" type="button" value="회원가입" onclick="window.location='join'">
		    </div>
