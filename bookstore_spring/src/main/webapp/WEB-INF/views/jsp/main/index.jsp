...
<div class="slideContainer">
	<div class="mySlides fade">
		<img class="slideImg" src="${imageSlide}slide01.jpg">
	</div>
	<div class="mySlides fade">
		<img class="slideImg" src="${imageSlide}slide02.jpg">
	</div>
	<div class="mySlides fade">
		<img class="slideImg" src="${imageSlide}slide03.jpg">
	</div>
	<div class="mySlides fade">
		<img class="slideImg" src="${imageSlide}slide04.jpg">
	</div>		
</div>
