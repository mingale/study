...
<div class="wrap clearfix">
	<c:if test="${cnt != 0}">
		<div class="container clearfix">
					...
					<c:forEach var="mem" items="${members}">
						<li>
							<ul class="item clearfix">
								<li class="chk">
									<input class="list" type="checkbox" name="list">
								...
								<li class="item_btn_area">
									<input type="button" value="수정" onclick="memUpdate('${mem.id}');">
									<input type="button" value="강퇴" onclick="window.location='memberDelete.ho?chk=0&id=${mem.id}';">
								</li>
							</ul>
						</li>
					</c:forEach>
			...
			<div class="btn_area">
				<input class="smallButton s1" type="button" value="선택 수정" onmouseover="navOver('s1');" onmouseout="navOut('s1');" onclick="allMemberUpdate();">
				<input class="smallButton s2" type="button" value="선택 탈퇴" onmouseover="navOver('s2');" onmouseout="navOut('s2');" onclick="allMemberDelete();">
			</div>
