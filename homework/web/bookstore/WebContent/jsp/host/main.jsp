...
<head>
	...
	<style>
		...
		.new{float:left;width:490px;height:250px;margin-top:20px;padding:0 10px;}
		.new > span{font-weight:bold;font-size:14px;}
		.new > ul{margin-top:20px;border:1px solid #c6c6c6;}
		.div{width:100%;height:100%;line-height:180px;margin:auto 0;text-align:center}
		.notice{float:right;width:100%;height:250px;}
