...
<head>
	...
	<style>
		...
		.title{width:400px;white-space:nowrap;text-overflow:ellipsis;overflow:hidden;}
		...
		.item_btn_area{width:80px;text-align:center;}
			...
			<c:forEach var="book" items="${books}">
				<li>
					<ul class="item clearfix">
						...
						<li class="chk"><input type="checkbox" name="list"></li>
						<li class="no">
							${book.no}
						...
						<li class="item_btn_area">
							<input type="button" name="btn_up" value="수정" onclick="window.location='stockUpdate.ho?no=${book.no}';">
							<input type="button" name="btn_del" value="삭제" onclick="if(confirm('정말 삭제하시겠습니까?')){window.location='stockDelete.ho?chk=0&no=${book.no}';}">
						</li>
					</ul>
				</li>
			</c:forEach>
