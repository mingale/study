...
<head>
	<style>
		...
		.detail img{float:left;word-wrap:break-word;width:205px;max-height:280px;margin:10px 50px 10px 10px;}
		.detail_info{float:left;word-wrap:break-word;width:auto;margin-top:10px;}
...
<div class="wrap">
	...
	<div class="detail clearfix">
		...
		<form class="detail_info" action="bookBtnPro.go?no=${book.no}" name="detailForm" method="post">
