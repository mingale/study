...
<head>
	...
	<style>
		...
		.btn_area .inputButton{float:left;width:49%;height:60px;font-size:24px;background:lightblue;margin:1px;}
...
<body>
<div class="wrap">
	<form class="container" action="/bookstore/signUp.do" name="joinForm" method="post" onsubmit="return joinCheck();">
		...
		<div class="btn_area clearfix">
			<input class="inputButton" type="button" value="비동의" onclick="window.location='index.do'">
